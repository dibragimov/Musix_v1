package il.co.pelephone.musix.UI.widget;
 ...
 */
public class MusixTabHost extends TabHost{

    private TabWidget mTabWidget;
    private FrameLayout mTabContent;
    private List<MusixTabSpec> mTabSpecs = new ArrayList<MusixTabSpec>(2);
    /**
    ...
    public MusixTabHost(Context context) {
        super(context);
        initTabHost();
    }

    public MusixTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTabHost();
    }
    ...
    /**
     * Get a new {@link MusixTabSpec} associated with this tab host.
     * @param tag required tag of tab.
     */
    public MusixTabSpec newMusixTabSpec(String tag) {
        return new MusixTabSpec(tag);
    }
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    /**
     * If you are using {@link MusixTabSpec#setContent(android.content.Intent)}, this
     ...
     */
    public void addTab(MusixTabSpec tabSpec) {
...
//    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
    	Log.i("MusixTabHost","handled "+((event == null)?"null":event.toString()));
        ...
        Log.i("MusixTabHost","handled "+handled);
...
//                && (mCurrentView.isRootNamespace())
    ...
    public void setCurrentTab(int index) {
        ...
        mCurrentTab = index;
        final MusixTabHost.MusixTabSpec spec = mTabSpecs.get(index);
    ...
    public class MusixTabSpec {
        ...
        private MusixTabSpec(String tag) {
            mTag = tag;
        }
         ...
         */
        public MusixTabSpec setIndicator(CharSequence label) {
         ...
         */
        public MusixTabSpec setIndicator(CharSequence label, Drawable icon) {
         ...
         * of the tab.
         */
        public MusixTabSpec setContent(int viewId) {
         ...
         */
        public MusixTabSpec setContent(TabContentFactory contentFactory) {
         ...
         */
        public MusixTabSpec setContent(Intent intent) {
    ...
    private class LabelIndicatorStrategy implements IndicatorStrategy {
        ...
        public View createIndicatorView() {
            ...
            final TextView tv = (TextView) tabIndicator.findViewById(R.id.tab_indicator_title);
            tv.setText(mLabel);
    ...
    private class LabelAndIconIndicatorStrategy implements IndicatorStrategy {
        ...
        public View createIndicatorView() {
            ...
            final ImageView iconView = (ImageView) tabIndicator.findViewById(R.id.tab_indicator_icon);
